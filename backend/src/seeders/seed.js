...
const seedData = async () => {
  try {
    ...
    const users = await User.create([
      {
        fullName: 'Mr.Om prakash (Super Admin)',
        email: 'admin@slms.com',
        password: 'admin123',
        role: 'super_admin',
        memberId: 'ADM-001001',
        department: 'Information Technology',
        phone: '+91 75620 25045'
      },
      {
        fullName: 'Mrs.Manshi chaudhary (Chief Librarian)',
      ...
      {
        fullName: 'Anuj srivastav (Student)',
      ...
      {
        fullName: 'Prof. Siddharat kumar (Faculty)',
